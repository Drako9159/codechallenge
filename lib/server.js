...
app.get("/v1/students/certificates/emails", (req, res) => {
    const studentsHaveCertification = StudentsController.getStudentsCertification(true);
    res.json({haveCertification: studentsHaveCertification});
});
app.get("/v1/students/nocertificates/emails", (req, res) => {
    const studentsHaveCertification = StudentsController.getStudentsCertification(false);
...
app.get("/v1/students/credits/:credits", (req, res) => {
    ...
    const studentsCredits = StudentsController.getStudentsCreditsOver500(credits);
